...
import com.songwie.blog.base.constant.Constant;
...
public class SessionCertification {
	...
	public static String getOperUserID(){
		...
		String operUser = (String) session.getAttribute(Constant.OPER_USER_ID);
		return operUser;
	}
	...
	public static String getOperUserRealName() {
		HttpServletRequest request = (HttpServletRequest) ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest();
		HttpSession session = request.getSession();
		String operUser = (String) session.getAttribute(Constant.OPER_USER_REAL_NAME);
		return operUser;
	}
	//获取当前操作员
	public static String getOperUserName() {
		HttpServletRequest request = (HttpServletRequest) ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest();
		HttpSession session = request.getSession();
		String operUser = (String) session.getAttribute(Constant.OPER_USER_NAME);
		return operUser;
	}
